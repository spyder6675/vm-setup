...
# alias nmap="grc nmap" 
alias myip='echo $(ifconfig eth0 | grep "inet " | cut -b 9- | cut -d" " -f2)'
alias int-ip='ip -br -c a'
alias extip='curl http://ipecho.net/plain; echo' # Get your external IP address.
...
#
# Responder/logs
alias copy-responderlogs='cp -r /opt/Responder/logs /root/testing/responderlogs'
